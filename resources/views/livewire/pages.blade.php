        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
                <td class="px-6 py-4 text-sm whitespace-no-wrap">
                    {{ $item->title }}
                    {!! $item->is_default_home ? '<span class="text-green-400 text-xs font-bold">[Default Home
                        Page]</span>' : '' !!}
                    {!! $item->is_default_not_found ? '<span class="text-red-400 text-xs font-bold">[Default 400
                        Page]</span>' : '' !!}
                </td>
                <td class="px-6 py-4 text-sm whitespace-no-wrap">
                ...
                <td class="px-6 py-4 text-sm whitespace-no-wrap">{!! \Illuminate\Support\Str::limit($item->content, 50,
                    '....') !!}</td>
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                <label>
                    ...
                    <span class="ml-2 text-sm text-red-600">Set as the default error 400 page</span>
                </label>
            </div>
            <div class="mt-4">
